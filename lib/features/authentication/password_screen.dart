...
import 'package:tiktok_clone_again/features/authentication/birthday_screens.dart';
import 'package:tiktok_clone_again/features/authentication/password_screen.dart';
...
class _PasswordScreenState extends State<PasswordScreen> {
  ...
  void _onSubmit() {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => const BirthdayScreens(),
      ),
    );
  }
